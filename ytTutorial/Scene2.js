class Scene2 extends Phaser.Scene {
  ...
  movePlayerManager() {
    ...
    if (this.cursorKeeys.up.isDown)
      this.player.setVelocityY(-gameSettings.playerSpeed);
    else if (this.cursorKeeys.down.isDown)
      this.player.setVelocityY(gameSettings.playerSpeed);
  }
  ...
  hurtPlayer(player, enemy) {
    let enemyExplosion = new Explosion(this, enemy.x, enemy.y);
    this.resetShipPos(enemy);
    this.explosionSound.play();

    if (this.player.alpha < 1) return;

    let playerExplosion = new Explosion(this, player.x, player.y);
